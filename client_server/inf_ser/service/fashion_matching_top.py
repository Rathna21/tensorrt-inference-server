...
class FashionMatchingTop(inference_pb2_grpc.InferenceAPIServicer):
    ...
    def __init__(self):
        ...
        self._MODEL_NAME = "fashion_matching_top"
        self._BATCH_SIZE = 1
    ...
    def prepare_request(self, img):
        ...
        output_list = ["base_network/lambda_3/l2_normalize"]
    ...
    def GetFashionMatchingTop(self, request, context):
        ...
        resp = inference_pb2.FashionMatchingTop()
